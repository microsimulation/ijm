...
final class AboutController extends Controller
{
    ...
    public function boardAction(Request $request) : Response
    {
        ...
        $arguments['body'] = [
            ...
            new Paragraph('<strong>Managing Editor</strong> - Dr Patryk Bronka (University of Essex, UK)'),
