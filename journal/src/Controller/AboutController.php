	...
	public function editorialPolicyAction(Request $request) : Response
	{
	    ...
	    $arguments['body'] = [
			...
			ArticleSection::basic('Compulsory statements', 2,
				$this->render(
					new Paragraph('The following statements should be included - where relevant and as discussed below - in all submissions, either as a separate file, at the end of the submitted manuscript, or in the Acknoweledgements section.'), 
					Listing::unordered([
					...
					new Paragraph('The statements will be published in the Acknowledgements of each article'),
	            )
	        ),
